...
export default function Customer() {
    ...
    React.useEffect(() => {
        axios.get('http://localhost:9999/CUSTOMER-SERVICE/query/customer/')
        .then(res => {
    ...
    if(customers.length === 0 && Loading===true) return (
  ...
  return (
    <div>
        <div className="flex justify-between items-center mt-10">
            <h1 className="text-3xl mx-12 md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4">Customers</h1>
